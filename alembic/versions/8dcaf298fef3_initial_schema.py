...
Revision ID: 8dcaf298fef3
Revises: 
Create Date: 2026-06-23 13:29:08.033560
...
def upgrade() -> None:
    ...
    ''')
    op.execute('CREATE INDEX IF NOT EXISTS idx_google_oauth_pending_created_at ON google_oauth_pending_states(created_at)')
    op.execute('''
