...
1. **`deploy_interactive.sh`** - Prompts for missing credentials, then runs deployment
2. **`deploy_with_verify.sh`** - Main deployment script with 8-step verification
3. **`DEPLOYMENT_GUIDE.md`** - Full documentation with troubleshooting
...
2. **Run:** `bash deploy_interactive.sh` (or use one of the other options above)
...
**Questions?** See `DEPLOYMENT_GUIDE.md` for detailed troubleshooting and FAQ.
