            ...
            <div className="flex flex-col md:flex-row gap-10">
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="flex justify-end">
                  <button className="bg-primary text-white px-8 py-2.5 rounded-lg font-bold shadow-md hover:opacity-90 transition-opacity">Save Changes</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 border border-slate-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <button className="w-full border-2 border-primary text-primary font-bold py-2 rounded-lg hover:bg-primary/5 transition-colors">Configure 2FA</button>
              </div>
              <div className="p-6 bg-slate-50 rounded-xl border border-slate-200">
  ...
  return (
    <div className="space-y-8 max-w-6xl" dir="rtl">
      <div className="flex justify-between items-end">
        ...
        <button className="flex items-center gap-2 px-6 py-2 bg-primary text-white rounded-lg font-bold shadow-md hover:opacity-90 transition-opacity">
          <UserPlus size={18} />
          מפגש חדש
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="flex items-center justify-between pt-4">
            ...
            <button className="px-8 py-3 bg-primary text-white rounded-lg font-bold shadow-lg hover:opacity-90 transition-opacity flex items-center gap-2 group">
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <button className="flex items-center justify-center gap-2 px-5 py-2.5 bg-primary text-white font-semibold rounded-xl shadow-md hover:opacity-90 transition-opacity">
          <UserPlus size={18} />
          New Patient
        </button>
      </div>
